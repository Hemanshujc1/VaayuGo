                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {item.file_url && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 mt-3 bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 rounded-lg text-xs font-medium transition-colors w-fit border border-blue-500/20"
                          >
                            <svg
