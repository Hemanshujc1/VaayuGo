            ...
            <div className="flex justify-between gap-2">
              {otp.map((data, index) => (
                <input
                  ...
                  className="w-full h-12 text-center text-xl font-bold bg-neutral-mid border border-neutral-light/20 rounded-lg text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
                  required
                />
              ))}
            </div>
