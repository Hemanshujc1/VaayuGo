...
const ShopProfile = () => {
  ...
  return (
    <div className="text-primary-text max-w-4xl mx-auto p-4 md:p-8">
      ...
      {/* User Info Card */}
      <div className="bg-neutral-dark p-4 md:p-6 rounded shadow border border-neutral-mid mb-8">
      ...
      {/* Shop Info Card */}
      <div className="bg-neutral-dark p-4 md:p-6 rounded shadow border border-neutral-mid">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-neutral-mid pb-2">
          Shop Details
        </h2>
