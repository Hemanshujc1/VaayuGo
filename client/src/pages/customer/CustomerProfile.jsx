    ...
    <div className="min-h-[calc(100vh-64px)] bg-primary py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-neutral-dark rounded-2xl shadow-xl overflow-hidden border border-neutral-light/20">
          <div className="bg-neutral-dark border-b border-neutral-light/10 p-6 sm:p-10 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-6">
              <div className="h-24 w-24 shrink-0 rounded-full bg-white/20 border-4 border-white/40 flex items-center justify-center text-4xl font-bold uppercase shadow-lg">
