...
const AdminSettlements = () => {
  ...
  return (
    <div className="p-4 md:p-8 bg-primary min-h-screen text-primary-text font-sans space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto mt-4 md:mt-0">
          <button
            ...
            disabled={triggering}
            className="flex-1 md:flex-none bg-neutral-mid text-white px-4 py-2 rounded font-bold hover:bg-neutral-light transition-all disabled:opacity-50 text-sm whitespace-nowrap"
          >
          ...
          <button
            ...
            disabled={triggering}
            className="flex-1 md:flex-none bg-accent text-primary px-6 py-2 rounded font-bold hover:shadow-[0_0_15px_rgba(32,226,224,0.4)] transition-all disabled:opacity-50 text-sm whitespace-nowrap"
          >
              ...
              {loadingOrders ? (
                ...
                <div className="space-y-3">
                  ...
                  {selectedSettlement.penalty_total > 0 && (
                    <Link
                      to="/admin/penalties"
                      className="bg-red-500/10 border border-red-500/30 p-4 rounded-xl flex flex-row justify-between items-center w-full hover:bg-red-500/20 transition-colors cursor-pointer text-left"
                    >
                      <div>
                        ...
                        <p className="text-[10px] text-red-500/70">
                          Subtracted from net payout. Click to view ledger.
                        </p>
                      </div>
                  ...
                  <div className="bg-accent/10 border border-accent/30 p-6 rounded-xl flex justify-between items-center mt-6">
                    <div>
                      <p className="text-accent font-bold text-lg tracking-tight">
